...
void test11(){
    ...
    /*数的存储
     ...
     +8的原码:0000 0100
     -8的原码:1000 0100
     0的原码:0000 0000 / 1000 0000  (0的原码 有二个)

     反码:
     正数:正数的反码 = 原码 【+8的反码:0000 0100】
     负数:在原码的基础上，符号位不变其他位按位取反(就是0变1，1变0)【-8的反码:1111 1011】
     0的反码:0111 1111  / 1111 1111 (0的反码 有二个)


     补码:
     正数:正数的反码 = 原码 【+8的补码:0000 0100】
     负数:在反码的基础上按照正常的加法运算加1【-8的反码:1111 1011 + 1 = 1111 1100】
     0的补码:
     +0反码:0111 1111 + 1 =   1000 0000 ===>         1为符号位,000 0000 为真值的绝对值
     -0反码:1111 1111 + 1 =  10000 0000 ===> 1进位被丢弃，0为符号位,000 0000 为真值的绝对值
